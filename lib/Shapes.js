...
class Circle extends Shape {
    constructor (color, text, fillcolor) {
        ...
        this.text = `<text fill="${this.color}" font-size="45" font-family="Verdana" x="51" y="115">${this.text}</text>`;
...
class Polygon extends Shape {
    constructor (color, text, fillcolor) {
        super(color, text, fillcolor);
        this.text = `<text fill="${this.color}" font-size="20" font-family="Verdana" x="28" y="70">${this.text}</text>`;
